...
export default function Home() {
  ...
  return (
    <main className={styles.main}>
      ...
      <CityForm currentCity={currentCity} onResetData={() => setCurrentCity({})} onSaveData={saveCityMutation.mutate}></CityForm>
      {
        isLoadingCities ? <CircularProgress size={150} sx={{m: 5}}/>
        : <CityTable cities={cities || []} onEditData={handleEditCity} onDeleteData={deleteCityMutation.mutate}></CityTable>
      }
    </main>
  );
}
